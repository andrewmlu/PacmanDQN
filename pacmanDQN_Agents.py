...
params = {
    ...
    'load_file': None,
    # 'save_file': 'train_smallClassic_directional_2304013_1556',
    'save_file': None,
    'save_interval': 30000,
...
class PacmanDQN(game.Agent):
    def __init__(self, args):
        ...
        gpu_options = tf.compat.v1.GPUOptions(per_process_gpu_memory_fraction=0.1) # debug: modified from tensorflow v2 to v1
